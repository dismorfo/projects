<div id='branding'>
  <div class='limiter clearfix'>
    ...
    <?php endif; ?>
    <?php if (isset($user_login_block)) : ?>
      <div class="login"><?php print t('<a href="@url">Log in</a>', array('@url' => url('user'))) ?></div>
    <?php endif; ?>
  </div>
</div>
...
<?php if (isset($user_login_block)) : ?>
  <div class="login_block element-hidden"><?php print render($user_login_block); ?></div>
<?php endif; ?>